...
namespace FabOS.WebServer.Migrations
{
    ...
    [Migration("20251104042441_TrackManualItemManagementTablesCreation")]
    partial class TrackManualItemManagementTablesCreation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FabOS.WebServer.Models.Entities.ITPAssembly", b =>
                {
                    ...
                    b.Property<int>("WorkOrderAssemblyId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("WorkOrderAssemblyId");
            ...
            modelBuilder.Entity("FabOS.WebServer.Models.Entities.MaterialTraceability", b =>
                {
                    ...
                    b.Property<int?>("WorkOrderInventoryItemId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("WorkOrderInventoryItemId");
            ...
            modelBuilder.Entity("FabOS.WebServer.Models.Entities.WorkPackage", b =>
                {
                    ...
                    b.Property<decimal>("BillableValue")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("FabOS.WebServer.Models.Entities.ITPAssembly", b =>
                {
                    ...
                    b.HasOne("FabOS.WebServer.Models.Entities.WorkOrderAssembly", "WorkOrderAssembly")
                        .WithMany()
                        .HasForeignKey("WorkOrderAssemblyId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("WorkOrderAssembly");
                });
            ...
            modelBuilder.Entity("FabOS.WebServer.Models.Entities.MaterialTraceability", b =>
                {
                    ...
                    b.HasOne("FabOS.WebServer.Models.Entities.WorkOrderInventoryItem", "WorkOrderInventoryItem")
                        .WithMany()
                        .HasForeignKey("WorkOrderInventoryItemId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("WorkOrderInventoryItem");
                });

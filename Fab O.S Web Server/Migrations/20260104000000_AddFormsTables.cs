...
namespace FabOS.WebServer.Migrations
{
    ...
    public partial class AddFormsTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FormType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SectionOrder = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassFailComment = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ModifiedByUserId = table.Column<int>(type: "int", nullable: true),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FormTemplates_CompanyId_IsDeleted",
                table: "FormTemplates",
            ...
            // Indexes for FormTemplateFields
            migrationBuilder.CreateIndex(
                name: "IX_FormTemplateFields_FormTemplateId",
            ...
            // Indexes for FormInstances
            migrationBuilder.CreateIndex(
                name: "IX_FormInstances_CompanyId",
                table: "FormInstances",
                column: "CompanyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FormInstances_CompanyId_LinkedEntityType_LinkedEntityId",
                table: "FormInstances",
            ...
            // Indexes for FormInstanceValues
            migrationBuilder.CreateIndex(
                name: "IX_FormInstanceValues_FormInstanceId",
            ...
            // Indexes for FormInstanceAttachments
            migrationBuilder.CreateIndex(
            ...
            // Add FormLink column properties to EstimationWorksheetColumns
        ...
        {
            // Remove columns from EstimationWorksheetColumns
            ...
            migrationBuilder.DropTable(name: "FormInstanceAttachments");
            migrationBuilder.DropTable(name: "FormInstanceValues");
            migrationBuilder.DropTable(name: "FormInstances");
            migrationBuilder.DropTable(name: "FormTemplateFields");
